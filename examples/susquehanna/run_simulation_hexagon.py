...
for iResolution in range(1, nResolution):        
    ...
    if iFlag_visualization == 1:
        oPyhexwatershed._plot(iFlag_type_in =1, sVariable_in = 'elevation')             
        oPyhexwatershed._plot(iFlag_type_in =1, sVariable_in = 'slope') 
        oPyhexwatershed._plot(iFlag_type_in =1, sVariable_in = 'drainagearea')   
        oPyhexwatershed._plot(iFlag_type_in =2, sVariable_in = 'flow_direction') 
        oPyhexwatershed._plot(iFlag_type_in =3, sVariable_in = 'flow_direction')    
        oPyhexwatershed._plot(iFlag_type_in =4, sVariable_in = 'flow_direction')   
    ...
    if iFlag_visualization == 1:
        ...
        sFilename = os.path.join(  oPyhexwatershed.sWorkspace_output_hexwatershed, 'surface_elevation' )
        oPyhexwatershed._plot(iFlag_type_in =1, sVariable_in = 'drainagearea')   
